...
#include "blastMeanVelocityForce.H"
...
namespace fv
{
    defineTypeNameAndDebug(blastMeanVelocityForce, 0);
    addToRunTimeSelectionTable(option, blastMeanVelocityForce, dictionary);
}
}
...
void Foam::fv::blastMeanVelocityForce::writeProps
(
    const scalar gradP
) const
{
...
Foam::fv::blastMeanVelocityForce::blastMeanVelocityForce
(
...
Foam::scalar Foam::fv::blastMeanVelocityForce::magUbarAve
(
...
void Foam::fv::blastMeanVelocityForce::correct(volVectorField& U)
{
...
void Foam::fv::blastMeanVelocityForce::addSup
(
    fvMatrix<vector>& eqn,
    const label fieldi
)
...
void Foam::fv::blastMeanVelocityForce::constrain
(
    fvMatrix<vector>& eqn,
    const label
)
...
bool Foam::fv::blastMeanVelocityForce::read(const dictionary& dict)
{
    NotImplemented;
